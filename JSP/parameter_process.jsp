...
<body>
<div>
<% //POST방식의 한글 처리 : (GET방식에서는 동작하지 않습니다.)
	//request객체가 사용되기 전에 encoding하여 변환한 문자열을 받는다.
	request.setCharacterEncoding("UTF-8");
%>
<strong><%= request.getMethod() %></strong> 방식의요청
<div>
<%
	...
	// value속성이 없다면 체크된 상태면 "on"이 입력되고 체크된 상대가 아니면 null 입력된다.
...
<br/>
	<label>select</label>
	<%
	String[] optValue ={"daum.net","naver.com","google.com"};
