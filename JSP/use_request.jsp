...
%>
	<ul>
		...
		<li>요청서버이름(domain) : <%= request.getServerName() %></li>
		...
		<li>parameter(이름 중복) : <%= request.getParameter("age") %></li>
		<!-- 이름이 같은 파라미터를 getParameter method를 사용하여 값을 얻으면 
			  가장 처음에 들어오는 값을 받는다. -->
		<li>parameter(이름 중복) : 
			<%
