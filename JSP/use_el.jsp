...
<ul>
	...
	<li>6-3 = ${6-3}</li>
	<li>6*3 = ${6*3}</li>
	<li>6/3 = ${6/3}</li><!-- EL에서는 나눈 결과가 실수로 나온다. -->
	<li>6%2 = ${6%2} ( ${ 6 mod 2} )</li><br/>
	<li><strong>산술연산자</strong></li>
	...
	<li>6!=3 = ${6!=3} ( <%-- ${ 6 ne 3} --%> )</li><!-- ne는 eclipse 버그로 오류표시가 뜬다 -->
	<li><strong>산술연산자</strong></li><br/>
	<li>true && true = ${true&&true} ( ${ true and true} )</li>
	<li>false || false = ${false||false} ( ${ false or false} )</li>
	<li><strong>삼항연산자</strong></li><br/>
	<li>2는 ${2%2 ==0?"짝수":"홀수"}</li><!-- EL에서 문자열은 " 와 ' 를 모두 사용할 수 있다. -->
	<li>3은 ${3%2 ==0?'짝수':'홀수'}</li><!-- EL에서 문자열은 " 와 ' 를 모두 사용할 수 있다. -->
	<li><strong>파라미터받기</strong></li><br/>
	<li>이름 : ${param.name}</li>
